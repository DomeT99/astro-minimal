<template>
  <button
    class="button is-primary is-rounded is-sticky"
    ...
    <div class="modal is-active">
      ...
      <div class="modal-card">
        <header class="modal-card-head">
          <p class="modal-card-title paragraph">Choose your language</p>
          <button
            class="delete"
            aria-label="close"
            @click="handleDropDown"
        ...
        <section class="modal-card-body">
          <div class="is-flex is-justify-content-center columns is-multiline">
            <div class="column is-6 is-12-mobile">
              <a href=""><button class="button w-100 is-large">🇬🇧</button></a>
            </div>
            <div class="column is-6 is-12-mobile">
              <a href=""><button class="button w-100 is-large">🇮🇹</button></a>
            </div>
        ...
        <footer class="modal-card-foot is-flex is-justify-content-end"></footer>
      </div>
    </div>
  </template>
</template>
